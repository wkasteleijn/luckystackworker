...
public class UtilTest {
  ...
  void testGetFilename() {
    ...
    Assertions.assertEquals(
        expectedFilename, LswFileUtil.getFilename(PATH_WITHOUT_EXTENSION_AND_FOLDER));
    Assertions.assertEquals(
        expectedFilename, LswFileUtil.getFilename(PATH_WITH_DOT_IN_FOLDER_PREFIX));
  ...
  void testGetFilenameExtension() {
    ...
    Assertions.assertEquals(
        expectedFilenameExtension, LswFileUtil.getFilenameExtension(PATH_WITH_DOT_IN_FOLDER));
    Assertions.assertEquals(
        expectedFilenameExtension, LswFileUtil.getFilenameExtension(PATH_WITHOUT_FOLDER));
    Assertions.assertEquals(
        "", LswFileUtil.getFilenameExtension(PATH_WITHOUT_EXTENSION_AND_FOLDER));
    Assertions.assertEquals(
        expectedFilenameExtension,
        LswFileUtil.getFilenameExtension(PATH_WITH_DOT_IN_FOLDER_PREFIX));
