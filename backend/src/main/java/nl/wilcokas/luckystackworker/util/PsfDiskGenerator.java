...
public class PsfDiskGenerator {
    ...
    public static ImagePlus generate16BitRGB(
            double airyDiskRadius, double seeingIndex, double diffractionIntensity, String profileName, boolean isMono)
            throws IOException {
    ...
    private static FloatProcessor generate(
            double wavelength, double airyDiskRadius, double seeingIndex, double diffractionIntensity, int imageSize) {
