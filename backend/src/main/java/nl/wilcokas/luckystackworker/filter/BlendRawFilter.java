...
public class BlendRawFilter {
    ...
    public void apply(ImagePlus image, final LswImageLayersDto unprocessedImageLayers, double blendRawRedFactor, double blendRawGreenFactor, double blendRawBlueFactor) throws Exception {
