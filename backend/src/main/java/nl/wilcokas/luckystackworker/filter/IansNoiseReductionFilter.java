...
public class IansNoiseReductionFilter implements LSWFilter {
    ...
    private void apply(final ImagePlus image, final String profileName, final IansNoiseReductionParameters parameters, double scale, double rotationAngle) {
        for (int i = 0; i < parameters.getIterations(); i++) {
            ...
            gmicService.callGmicCli(image, profileName, scale, rotationAngle, Arrays.asList("iain_nr_2019",
