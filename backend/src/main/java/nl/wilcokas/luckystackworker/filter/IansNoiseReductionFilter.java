...
public class IansNoiseReductionFilter {
    ...
    public void apply(final ImagePlus image, final String profileName, final IansNoiseReductionParameters parameters)
        ...
        gmicService.callGmicCli(image, profileName, Arrays.asList("iain_nr_2019",
