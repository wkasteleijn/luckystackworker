...
public class ProfileController {
  ...
  public ResponseEntity<PSFImageDto> updateProfile(
    ...
    if (activeOperationTime == null
        || LocalDateTime.now()
            .isAfter(
                activeOperationTime.plusSeconds(Constants.MAX_OPERATION_TIME_BEFORE_RESUMING))) {
    ...
    return psfImage == null
        ...
        : ResponseEntity.ok(
            PSFImageDto.builder().imageData(Base64.getEncoder().encodeToString(psfImage)).build());
  }
