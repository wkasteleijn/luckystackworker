...
class DispersionCorrectionFilter : LSWFilter {
  ...
  private fun isManuallyCorrected(profile: Profile): Boolean {
    return profile.dispersionCorrectionRedX != 0.0 ||
        profile.dispersionCorrectionRedY != 0.0 ||
        profile.dispersionCorrectionBlueX != 0.0 ||
        profile.dispersionCorrectionBlueY != 0.0
  }
  ...
  private fun updateDispersionCorrection(
      turboReg: TurboReg_,
      profile: Profile,
      channel: ChannelEnum,
  ) {
