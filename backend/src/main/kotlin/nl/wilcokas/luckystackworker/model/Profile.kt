...
data class Profile(
    ...
    private fun mapFromDTO(profile: ProfileDTO) {
        ...
        if (profile.applyToChannel == ChannelEnum.RGB) {
            ...
            // TODO: assign from green and blue channels once they exist
            this.psf?.airyDiskRadiusGreen = psfDTO!!.airyDiskRadius
            this.psf?.diffractionIntensityGreen = psfDTO!!.diffractionIntensity
            this.psf?.seeingIndexGreen = psfDTO!!.seeingIndex

            this.psf?.airyDiskRadiusBlue = psfDTO!!.airyDiskRadius
            this.psf?.diffractionIntensityBlue = psfDTO!!.diffractionIntensity
            this.psf?.seeingIndexBlue = psfDTO!!.seeingIndex
            this.psf?.type = psfDTO!!.type
        ...
        this.saveScale = profile.saveScale
        this.saveDimensionX = profile.saveDimensionX
        this.saveDimensionY = profile.saveDimensionY
    }
}
